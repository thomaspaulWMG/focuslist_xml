...
## TPA DEV
connect-pnponline -url https://wmgdev.sharepoint.com/sites/CE-Focus-List2

## Layer2 Dev 3 FC 4
connect-pnponline -url https://warnermusicdev03.sharepoint.com/sites/FocusList04

## Layer2 Dev 4 FC 1
connect-pnponline -url https://warnermusicdev04.sharepoint.com/sites/FocusList01
...
##Export to XML:
Export-PnPTermGroupToXml -Out c:\temp\termprod.xml -Identity "WM Central Europe"
...
Export-PnPListToProvisioningTemplate -Out c:\temp\focuslistDEV210224.xml -List "Focus List"
